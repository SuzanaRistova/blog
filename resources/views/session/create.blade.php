                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('session.store') }}">
                        ...
                        <div class="form-group{{ $errors->has('content') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="content" type="text" class="form-control" name="content" value="{{ old('content') }}" placeholder="Content" required></textarea>
                        ...
                        <div class="form-group{{ $errors->has('video') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="video" type="text" class="form-control" name="video" value="{{ old('video') }}" placeholder="Video" required>
                        ...
                        <div class="form-group{{ $errors->has('completed') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="completed" type="text" class="form-control" name="completed" value="{{ old('completed') }}" placeholder="Completed" required>
                        ...
                        ?>
                        <input id="lesson_id" type="hidden" class="form-control" name="lesson_id" value="<?=$url[2] ?>" placeholder="lesson_id" required>
